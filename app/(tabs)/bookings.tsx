    ...
    <FlatList
      ...
      ListEmptyComponent={
        <Empty
          ...
          // Текст отправляет в каталог, кнопка туда и ведёт. Свежий
          // участник видит эту вкладку сразу после входа: сказать, что
          // делать, и не дать чем — значит оставить его на пустом экране.
